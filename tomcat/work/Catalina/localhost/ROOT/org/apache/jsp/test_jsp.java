 ...
 * Generated at: 2020-06-15 03:50:01 UTC
...
int totalRow      = 0;   //게시물 전체 갯수
int pageSize      = 7;  //페이지당 출력 할 갯수
int currentPage = 4;  //현재 페이지 번호 
int startRow      = 0;  //시작행 번호
int mRowNo     = 0;   //화면에 출력할 행번호
...
mResult.next();
totalRow =  Integer.parseInt(mResult.getString("totalrow"));
out.print("전체 게시물 :" + totalRow);
mResult.close();
mState.close();

//최대페이지 = (전체 갯수 / 페이지당 갯수) + 1
maxPage = (totalRow / pageSize);
...
mSQL += "	board ";
//limit 시작행번호,페이당 갯수
mSQL += "limit " + startRow + "," + pageSize;
System.out.println("페이지 번호 :" + currentPage + ", 시작행번호 :" + startRow + ", 페지당 갯수:" + pageSize);
