	...
	<table style="width:100%;">
		<tr>
			<form id="writereply" name="writereply" action="submitreply()" method="post">
				...
				<td style="width:80%; "><textarea name="replycontent" onkeyup="enterkey(${cateid}, ${b_num});" id="replycontent" style="resize: none; width:95%; font-size:20px; padding:10px; " rows="1"></textarea></td>
			</form>
